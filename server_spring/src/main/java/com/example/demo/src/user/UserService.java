...
//    }
    ...
    public void createNumber(int number) throws BaseException {
        try {
              userDao.putNumber(number);
...
//    public User createUser(PostSighReq postSighReq) throws BaseException {
//        try {
//            return userDao.createUser(postSighReq);
...
//    }
    ...
    public PostLoginRes logIn(PostLoginReq postLoginReq) throws BaseException {
        try {
            String jwt = jwtService.createJwt(userDao.logIn(postLoginReq));
            return new PostLoginRes(userDao.logIn(postLoginReq), jwt);
        } catch (Exception exception) {
            throw new BaseException(DATABASE_ERROR);
        }
    }
